      ...
      <div className="section--default--gray padding--t64b64 m-32">
        ...
        <div className="w-layout-grid benefit__grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <h6 className="benefit_bullet_title text-xl font-bold ">
              Solve real problems
            </h6>
            <p>
              We solve real problems that matter to our customers and us. We
              don't chase ideas and trends. We solve problems for long-term
              value creation over short-term results
            </p>
          </div>
          <div
            className="benefit-card text-center"
          ...
          >
            ...
            <p>We are biased towards action and results.</p>
          </div>
          <div
            className="benefit-card text-center"
            style={{

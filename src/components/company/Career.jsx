  ...
  <div className="relative h-[400px] lg:h-auto">
    {images.map((imageUrl, index) => (
      ...
      />
        ...
        <br/><br/><br/>
        <div className="home-container tb-padding w-container bg-gray-100"><br/>
  <div className="career-section-title text-[rgb(0,223,154)] text-xl ml-5">① Who are we</div><br/>
  <div className="maxw-100 ml-28 mr-28">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div id="w-node-_94cd05ae-aae5-5323-ef41-95384da19b30-318ce6fb">
        <img
      ...
      <div id="w-node-_94cd05ae-aae5-5323-ef41-95384da19b24-318ce6fb" className="split-content-r align-c lg:pl-8">
        ...
        At Vyas, we believe anything that can be seen will be turned into software.
                ...
                building with Vyas tools.</p>
      </div>
    </div>
  </div>
</div>

        <div className="home-container tb-padding w-container bg-white"><br/>
  <div className="career-section-title text-[rgb(0,223,154)] text-xl ml-5">② What We're Looking For</div><br/>
  <div className="maxw-100 ml-32 mr-32">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div id="w-node-_94cd05ae-aae5-5323-ef41-95384da19b30-318ce6fb">
        <img
      ...
      <div id="w-node-_94cd05ae-aae5-5323-ef41-95384da19b24-318ce6fb" className="split-content-r align-c lg:pl-8">
        ...
        <a
          href="#Open-Positions"
          className="bg-[#00df9a] rounded-md font-medium my-6 py-4 px-10 text-black text-center"
        >
          see
        </a><br/><br/>
      </div>
...
<div className="home-container tb-padding w-container bg-gray-100"><br/>
  <div className="career-section-title text-[rgb(0,223,154)] text-xl ml-5"> How We Work Together</div><br/>
  <div className="maxw-100 ml-32 mr-32">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div id="w-node-_94cd05ae-aae5-5323-ef41-95384da19b30-318ce6fb">
        <img
...
<div className="home-container tb-padding w-container bg-white"><br/>
  <div className="career-section-title text-[rgb(0,223,154)] text-xl ml-5"> Where We Work</div><br/>
  <div className="maxw-100 ml-32 mr-32">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div id="w-node-_94cd05ae-aae5-5323-ef41-95384da19b30-318ce6fb">
        <img
